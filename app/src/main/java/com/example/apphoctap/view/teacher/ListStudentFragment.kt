...
import com.example.apphoctap.view.teacher.Adapter.ListStudentAdapter
import com.example.apphoctap.view.viewmodel.teacher.ListStudentViewModel
...
class ListStudentFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        classID = arguments?.getString("classID")  // Gán classID
        ...
        studentAdapter = ListStudentAdapter(
            ...
            onDelete = { studentItem ->
                ...
                btnDelete.setOnClickListener {
                    viewModel.deleteStudent(studentItem.studentID)
